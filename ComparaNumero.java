...
Turma: LEIT14.
Compilar: javac ComparaNumero.java
Executar: java ComparaNumero
2022
	...
	public class ComparaNumero {
		...
		private static Scanner lerDados;
			...
			public static void main(String[] args) {
				...
				lerDados = new Scanner (System.in); //Classe Scanner
				...
				ComparaNumero obj = new ComparaNumero(); 
				obj.comparacaoNumeros(num1,num2); //Chamando o metodo para comprar se os numeros sao iguais ou diferentes 
			...
			public void comparacaoNumeros(int valor1, int valor2) {
